...
//cross stanley 
Matrix MatrixMath::cross(const Matrix& A,const Matrix& B)
{
	Matrix result(3,1);

    if( (A._nRows == 3) && (B._nRows == 3))
    {
		if(  (A._nCols == 1) && (B._nCols == 1))   
        {

           
            result._matrix[0][0] =  A._matrix[1][0]*B._matrix[2][0]-A._matrix[2][0]*B._matrix[1][0];//a1b2-a2b1
            result._matrix[1][0] =	A._matrix[2][0]*B._matrix[0][0]-A._matrix[0][0]*B._matrix[2][0];//a2b0-a0b2
            result._matrix[2][0] =	A._matrix[0][0]*B._matrix[1][0]-A._matrix[1][0]*B._matrix[0][0];//a0b1-a1b0        
         }
	}
	else
	{
