...
BEGIN_MESSAGE_MAP(CSewingRobotApp, CWinApp)
...
CSewingRobotApp::CSewingRobotApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CSewingRobotApp 物件

CSewingRobotApp theApp;


// CSewingRobotApp 初始設定

BOOL CSewingRobotApp::InitInstance()
{
